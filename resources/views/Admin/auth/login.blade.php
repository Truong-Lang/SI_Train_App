@extends(\App\Common\Constant::FOLDER_URL_ADMIN.'.layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('login')])
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      ...
      <div class="row">
        ...
        <div class="col-6 text-right">
            <a href="{{ route(\App\Common\Constant::FOLDER_URL_ADMIN . '.password.email') }}" class="text-light">
                <small>{{ __('Forgot Password') }}</small>
            </a>
        </div>
      </div>
