@extends(\App\Common\Constant::FOLDER_URL_ADMIN.'.layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Register')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route(\App\Common\Constant::FOLDER_URL_ADMIN . '.auth.register') }}">
        @csrf
